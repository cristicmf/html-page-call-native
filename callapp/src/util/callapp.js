...
export const basicUrl = {
  ...
  UA_QZONE_REG: /Qzone\//,
  UA_QQ_REG: /QQ\//,
  URL_DOWNLOAD_DETAIL_ANDROID: 'URL_DOWNLOAD_DETAIL_ANDROID',
  URL_DOWNLOAD_DETAIL_IOS: 'URL_DOWNLOAD_DETAIL_IOS',
  URL_LIST_ANDROID_CALL: 'URL_LIST_ANDROID_CALL',
  URL_LIST_IOS_CALL: 'URL_LIST_IOS_CALL',
  URL_DOWNLOAD_ANDROID: 'URL_DOWNLOAD_ANDROID',
  URL_DOWNLOAD_ANDROID_WX: 'URL_DOWNLOAD_ANDROID_WX',
  URL_DOWNLOAD_IOS: 'URL_DOWNLOAD_IOS',
  URL_DOWNLOAD_IOS_WX: 'URL_DOWNLOAD_IOS_WX',
  URL_DOWNLOAD_PC: 'URL_DOWNLOAD_PC',
  shareTips: 'shareTips'
}
...
export const resetUrl = (urlMsg) => {
  ...
  const getDetailUrl = {
    ...
    URL_DOWNLOAD_PC: 'URL_DOWNLOAD_PC',
    shareTips: 'shareTips' + urlMsg.iosCallappUrl.param
  }
  return getDetailUrl
}
...
export const selectCallAPP = (platfromData) => {
  ...
  console.log('selectCallAPP url:' + url)
  console.log('selectCallAPP downloadUrl:' + downloadUrl)
  switch (true) {
...
export const setPlatfrom = () => {
  ...
  let ua = window.navigator.userAgent
  console.log('[setPlatfrom]', {appUrl: basicUrl})
  const platFormMsg = platForm(ua, basicUrl)
  console.log('[setPlatfrom]', {platFormMsg: platFormMsg})
  return platFormMsg
}
